...
let divChapter2 = '<img src="image/004.jpg">' +
  '<p class="imageCredit">注：照片为1876年蒸汽船<a href="http://www.messageries-maritimes.org/extreme-orient.htm">Djemnah</a></p>' +
...
let divChapter4 ='<img style="width:80%" src="image/007.jpg">'
+ '<p> 苏伊士运河航线开通后，由于偏离航线<span style="color:red;">毛里求斯</span>早早就被演出市场抛弃。与之相反的是<span style="color:red;">马尼拉</span>，在1890年美西战争的结束之后，迅速成为了巡回马戏演出的重要市场。</p>';
...
var config = {
  ...
  theme: "light",
  alignment: "left",
  topTitle: "历史地理空间叙述 | Historic Cartographic Narratives",
  ...
  + '<iframe class ="w-half" allowfullscreen="" src="/html/Singapore.html" loading="eager"> </iframe>'
  ...
  +'<p>对比香港和上海在这个问题上采取了另一种思路，二十世纪的上海马戏表演场地多位于在城中赛马场。香港与之类似，用市政厅附近的板球场地作为巡回马戏的演出场地，这样即避免了扰民问题，也可以在比赛季之余综合利用场地。</p>'
  +'<p>基于以上种种问题，随着现代城市和娱乐产业的发展，巡回马戏产业开始丧失竞争优势。1900年3月《自由西报》（Singapore Free Press and Mercantile Advertiser）刊文讨论城市是否应该学习曼谷和西贡的经验，为巡回马戏建造更更精美的临时演出场地，或修剪掉影响帐篷搭建的林荫大道的树冠。十年后同专栏的报道可以看到，这些年城市公共资金流向了音乐厅、剧院、道路和公园，而不是马戏产业。随后电影艺术这一强力竞争对手的出现，更是直接影响到巡回马戏的票房，如Harmston马戏团1909年11月在新加坡的巡回演出就受到了电影娱乐的直接冲击。（《海峡时报》（The Strait Times） 11 nov. P7）巡回马戏产业由于场地难寻、运营准备繁杂和动物表演风险高等种种内在原因，又加之电影等新兴娱乐形式的出现，进入二十世纪后开始逐渐式微。</p>'
  ...
  footer: "Study is based on the database of newspaper reports of touring circuses in Asia from 1861-1911, collected and organized by <a href='javascript:;'>Meimei Xu</a> and <a href='http://www.sunyanarch.com'>Yan Sun</a>.<br>Source: Database of the North-China Daily News, the Strait Times, Hong Kong Daily Press etc.    Colombia University WEAI, National Library of Australia, P&O Steam Navigation Company, L'Encyclopédie des Messageries Maritimes.",
